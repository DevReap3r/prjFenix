...
Partial Class frmConsultaModelo
    ...
    Private Sub InitializeComponent()
        ...
        Me.coluna_tipo = New System.Windows.Forms.DataGridViewTextBoxColumn()
        Me.coluna_descrição = New System.Windows.Forms.DataGridViewTextBoxColumn()
        Me.coluna_preco = New System.Windows.Forms.DataGridViewTextBoxColumn()
        ...
        Me.datagridServicos.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle1
        ...
        Me.datagridServicos.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle2
        ...
        Me.datagridServicos.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() {Me.coluna_tipo, Me.coluna_descrição, Me.coluna_preco})
        ...
        Me.coluna_tipo.ReadOnly = True
        '
        'coluna_descrição
        '
        Me.coluna_descrição.HeaderText = "Descrição"
        Me.coluna_descrição.Name = "coluna_descrição"
        Me.coluna_descrição.ReadOnly = True
        '
        'coluna_preco
        '
        Me.coluna_preco.HeaderText = "Preço"
        Me.coluna_preco.Name = "coluna_preco"
        Me.coluna_preco.ReadOnly = True
        '
        'Guna2VScrollBar1
        '
    ...
    Friend WithEvents coluna_tipo As DataGridViewTextBoxColumn
    Friend WithEvents coluna_descrição As DataGridViewTextBoxColumn
    Friend WithEvents coluna_preco As DataGridViewTextBoxColumn
